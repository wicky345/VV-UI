...
```html
<template>
  <ox-transfer v-model="value1" :data="data"></ox-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <ox-transfer
      ...
      @change="handleChange"
      :data="data">
      <ox-button class="transfer-footer" slot="left-footer" size="small">操作</ox-button>
      <ox-button class="transfer-footer" slot="right-footer" size="small">操作</ox-button>
    </ox-transfer>
  </div>
