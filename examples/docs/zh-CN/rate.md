...
<div class="block">
  ...
  <ox-rate v-model="value1"></ox-rate>
</div>
<div class="block">
...
| icon-classes | icon 的类名数组，共有 3 个元素，为 3 个分段所对应的类名 | array | — | ['ox-icon-star-on', 'ox-icon-star-on','ox-icon-star-on'] |
| void-icon-class | 未选中 icon 的类名 | string | — | ox-icon-star-off |
| disabled-void-icon-class | 只读时未选中 icon 的类名 | string | — | ox-icon-star-on |
