      ...
      renderContent(h, { node, data }) {
        return (
          <span class="custom-tree-node">
            ...
            <span>
              <ox-button size="mini" type="text" on-click={ () => this.append(data) }>Append</ox-button>
              <ox-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</ox-button>
            </span>
          </span>);
      },
...
:::demo
```html
<ox-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></ox-tree>
...
<div class="buttons">
  <ox-button @click="getCheckedNodes">通过 node 获取</ox-button>
  <ox-button @click="getCheckedKeys">通过 key 获取</ox-button>
  <ox-button @click="setCheckedNodes">通过 node 设置</ox-button>
  <ox-button @click="setCheckedKeys">通过 key 设置</ox-button>
  <ox-button @click="resetChecked">清空</ox-button>
</div>
